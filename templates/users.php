...
<html>
    ...
    <body>
        ...
        <div class="modal modal-remove modal--hidden modal-remove--friend">
            <div class="modal-close" onclick="remModal(false, 'modal-remove--friend', '');"></div>
            <div class="modal-img"></div>
            <h2 class="modal-header"></h2>
            <p class="modal-body"></p>
            <div class="modal-btns">
                <div class="modal-btn modal-btn-secondary" onclick="addFriend(false); remModal(false, 'modal-remove--friend', '');">Yes</div>
                <div class="modal-btn modal-btn-primary" onclick="remModal(false, 'modal-remove--friend', '');">No</div>
            </div>
        </div>

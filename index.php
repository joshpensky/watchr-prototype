        ...
        <div class="content">
            <div class="section" id="tracking">
                <div class="section-content">
                    <h2>Forgot where you left off?</h2>
                    <h3>We've got that covered.</h3>
                    <p>Gone are the days of going from episode to episode trying to remember what you last watched. We keep track of everything that you’ve seen on your streaming services, so you’ll never forget where you left off in a show or movie.</p>
                </div>
                <div class="section-img"></div>
            </div>
            <div class="section section--alt" id="recommends">
                <div class="section-content">
                    <h2>Stop searching.</h2>
                    <h3>Let us bring the content to you.</h3>
                    <p>Our recommendation algorithm gives you the perfect match for what to watch next. We even match our results to the services you have available to you. You’ll never be without something to watch.</p>
                </div>
                <div class="section-img"></div>
            </div>
            <div class="section" id="trophies">
                <div class="section-content">
                    <h2>Don't binge alone.</h2>
                    <h3>Challenge friends to binge battles.</h3>
                    <p>Everyone does it. Why not make it a competition? Challenge your friends to binge battles and see who can finish a show first. If you prove yourself worthy, you even get a trophy to add to your personal collection!</p>
                </div>
                <div class="section-img"></div>
            </div>
        </div>
